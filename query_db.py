...
def drop_tables(
    conn: psycopg2.extensions.connection, cur: psycopg2.extensions.cursor
) -> None:
    """
...
def extract_from_json(
    rooms_json: str, students_json: str
...
def extract_from_db(
    cur: psycopg2.extensions.cursor, query: str
) -> List[Dict[str, Any]]:
    """
    Queres a database.
...
def load_to_json(
    data: List[Dict[str, Any]], filename: str, ouput_folder: str, rewrite_ouput: bool
) -> None:
    """
...
def query_db_and_save_results(
    cur: psycopg2.extensions.cursor,
    queries_folder: str,
    format: str,
    ouput_folder: str,
    record_teg_xml: str = "record",
    rewrite_ouput: bool = True,
) -> None:
    """
